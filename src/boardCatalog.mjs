const TAISHAN_WORKBENCH_BOARD = {
  ...
  status: "available",
  route: "/studio/workbench?board=taishan-gray",
...
const WANGQI_BOARD_CATALOG = [
  {
    ...
    family: "ESP32-S3",
    status: "planning",
    route: "/studio/workbench?board=szpi-esp32s3&mode=demo",
  ...
  },
  {
    ...
    status: "planning",
    route: "/studio/workbench?board=huangshan-pi-sf32lb52&mode=demo",
  ...
  },
  {
    ...
    status: "experimental",
    route: "/studio/workbench?board=seeed-xiao-nrf52840-sense&mode=demo",
  ...
  },
  {
    ...
    status: "planning",
    route: "/studio/workbench?board=waveshare-esp32s3-touch-amoled-18&mode=demo",
  ...
  },
  {
    ...
    status: "planning",
    route: "/studio/workbench?board=waveshare-esp32p4-wifi6-touch-lcd-35&mode=demo",
