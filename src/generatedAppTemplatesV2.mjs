...
<body>
  <main class="screen ${modeClass}" data-mode="${htmlEscape(spec.mode)}">
    ...
    <header class="hud">
      <div>
        <span id="date">${spec.mode === "clock" ? "--C" : title}</span>
...
const weatherText = { 0: "Clear", 1: "Mostly clear", 2: "Partly cloudy", 3: "Cloudy", 45: "Fog", 61: "Light rain", 63: "Rain", 65: "Heavy rain", 80: "Showers", 95: "Thunderstorm" };
